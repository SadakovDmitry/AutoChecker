...
Проект не заменяет основной классификатор, который выбирает причину обращения. Его задача - проверить результат классификатора и решить, можно ли принять разметку автоматически или нужно отправить чат на ручную проверку.
...
<img src="docs/experiments/p_correct_sweep/precision_by_threshold.svg" width="100%">
...
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/coverage_by_threshold.svg" width="100%">
<br><b>Вывод:</b> чем ниже порог, тем больше авторазметки. Основной прирост покрытия находится в зоне `0.70-0.80`.
</td>
</tr>
<tr>
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/errors_by_threshold.svg" width="100%">
...
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/precision_coverage_tradeoff.svg" width="100%">
...
<tr>
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/all_topics_coverage_by_p_correct.svg" width="100%">
...
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/all_topics_precision_by_p_correct.svg" width="100%">
...
<tr>
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/all_topics_errors_by_p_correct.svg" width="100%">
...
<tr>
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/safe_mode/safe_precision_coverage_by_test.svg" width="100%">
...
<td width="50%" valign="top">
<img src="docs/experiments/p_correct_sweep/safe_mode/safe_yes_thresholds_by_reason.svg" width="100%">
